...
* **Set of known mutational signatures**: [COSMIC][3] v3.5 mutational signatures are used by default as the input reference signatures. Custom signature databases can also be used, and should be provided to the `cosmic_fit` function using the `signature_database` parameter.
