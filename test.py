...
def main():
    ...
    decomp.spa_analyze( samples, output, signatures=None,signature_database=sigs,genome_build="GRCh37", verbose=False,decompose_fit= False,denovo_refit=False,cosmic_fit=True)
