...
| **genome_build** | String | The genome build. Available genomes: "GRCh37", "GRCh38", "mm9", "mm10" and "rn6". The default value is "GRCh37". If a different genome is selected, the default genome will be used. |
